...
(function(b) {
    ...
    b.fn.uploadFile = function(t) {
        ...
        function p(v, u) {
            ...
            this.setting = b('<div class="frontend-setting" style="display: block !important;"><input type="checkbox" name="show_in_front['+i+']" value="1"  />&nbsp;Show to Customer</div>').appendTo(this.statusbar);
        ...
        function n(z, y, u, w, A) {
            ...
            var v = {
                ...
                success: function(B, s, C) {
					//u.statusbar.append("<input type='hidden' name='uploaded_file[]' value='"+w+"'/>");
                    A.responses.push(B);
