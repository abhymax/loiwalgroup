                        ...
                        <form id="profile_form" class="form-horizontal" enctype="multipart/form-data">
                            <div class="input-group">
                                ...
                                <div class="col-lg-6 col-md-10 col-sm-8 col-xs-7">
                                    <div class="form-line">
                                        <input type="text" class="form-control" id="admin_email" name="admin_email" placeholder="Enter your email" value="<?php echo e($data['admin_email']); ?>" maxlength="50">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <div class="col-lg-6 col-md-10 col-sm-8 col-xs-7">
                                    <div class="form-line">
                                        <input type="text" id="admin_username" class="form-control" name="admin_username" placeholder="Enter your username" value="<?php echo e($data['admin_username']); ?>"  maxlength="20">
                                    </div>
                                </div>
                            </div>
...
</script><?php /**PATH /home/j7lo9g5r3sz/public_html/portal.loiwalgroup.com/resources/views/profile/profile.blade.php ENDPATH**/ ?>