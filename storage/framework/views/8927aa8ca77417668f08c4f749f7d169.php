                    ...
                    <div class="card innerCards">
                        <div>
                            <div class="header">
                                ...
                                <a class="btn  btn-blue pull-right" href="<?php echo e(url('/')); ?>/materialout">Back</a>
                            </div>
							<div class="body">
												...
												<div class="form-group">
													<div class="form-line">
                                                        <select class="form-control district" name="district_id" id="district_id">
															...
															<option value="<?php echo e($district->district_id); ?>"><?php echo e($district->district_name); ?></option>
															<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /home/j7lo9g5r3sz/public_html/portal.loiwalgroup.com/resources/views/invoiceout/invoice_add.blade.php ENDPATH**/ ?>