                ...
                <div class="col-lg-12 innerCards" id="content-area">
                    ...
                    <div class="body">
                        <div class="table-responsive" id="adminusersListTableDiv">
                            <?php if(isset($data['adminusers']) && !empty($data['adminusers'])): ?>
                                <table id="adminusersListTable" class="table table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $data['adminusers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adminusers): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($adminusers['admin_username']); ?></td>
												<td><?php echo e($adminusers['admin_email']); ?></td>
												<td><?php if($adminusers['is_active']=='Y'): ?> Enabled <?php else: ?> Disabled <?php endif; ?></td>
												<td>
                                                    <div>
                                                        <a onclick="editAdminusers(<?php echo e($adminusers['admin_id']); ?>)" style="cursor:pointer; text-decoration: none">
                                                            <img src="<?php echo e(url('/')); ?>/public/assets/images/edit.svg">
                                                        </a>
                                                        <a onclick="deleteConfirm(<?php echo e($adminusers['admin_id']); ?>)" style="cursor:pointer; text-decoration: none">
                                                            <!--<i class="material-icons">delete</i>-->
                                                             <img src="<?php echo e(url('/')); ?>/public/assets/images/delete.svg">
                                                        </a>
                                                    </div>
                                                    <div id="delconfirm_<?php echo e($adminusers['admin_id']); ?>" class="slidediv">
                                                        <div class="slidediv-inner">
                                                            <span class="label">
                                                                Would you like to delete?
                                                                <a href="javascript:;" onclick="delrecord(<?php echo e($adminusers['admin_id']); ?>, 'adminusers', 'adminusersListTableDiv', 'adminusersListTable')">Yes</a> | <a href="javascript:;" onclick="closedeldiv(<?php echo e($adminusers['admin_id']); ?>)">No</a>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </td>
                                    ...
                                    <div class="formwrap">
										...
										<div class="row clearfix">
											...
											<div class="col-lg-4 col-md-10 col-sm-8 col-xs-7">
												<div class="form-group">
													<div class="form-line">
                                                            <?php $__currentLoopData = $data['supplierlist']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																<input type="checkbox" name="selected_supplier_ids[]" value="<?php echo e($supplier->supplier_id); ?>" style="position: unset; opacity: 1">
...
<?php /**PATH /home/j7lo9g5r3sz/public_html/portal.loiwalgroup.com/resources/views/subadmin/adminusers_list.blade.php ENDPATH**/ ?>