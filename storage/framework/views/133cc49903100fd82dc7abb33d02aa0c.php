...
<?php echo $__env->make('common/admin_main_navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <!-- Widgets -->
            <div class="row clearfix dbRow">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 dbGroup">
                    <div class="info-box">
                        <div class="icon">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 dbGroup">
                    <div class="info-box">
                        ...
                        <div class="content">
                            <div class="text">Inventories</div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 dbGroup">
                    <div class="info-box">
                        ...
                        <div class="content">
                            <div class="text">Delivery Quotes</div>
            ...
            <div class="row clearfix">
                <div class="col-sm-6">
                    <div class="card graphBox">
                        <div class="header">
                            <h2>Latest Delivery Quotes</h2>
                ...
                <div class="col-sm-6">
                    <div class="card graphBox">
                        <div class="header">
                            <h2>Latest Inventory Entries</h2>
                        </div>
                        <div class="body">
                            <div class="table-responsive tableData">
    ...
    <!--script src="<?php echo e(url('/')); ?>/public/assets/css/plugins/morrisjs/morris.js"></script-->
    <!-- Chart Plugins Js -->
    <script src="<?php echo e(url('/')); ?>/public/assets/css/plugins/chartjs/Chart.bundle.js"></script>

    <script src="<?php echo e(url('/')); ?>/public/assets/js/dashboard.js"></script>
...
<?php /**PATH /home/j7lo9g5r3sz/public_html/portal.loiwalgroup.com/resources/views/dashboard/dashboard.blade.php ENDPATH**/ ?>