                    ...
                    <div class="card">
                         <div class="searchFormHeader">
                            <div id="demo" class="collapse">
                             <form id="searchinvoice" class="form-horizontal searchForm" enctype="multipart/form-data" autocomplete="off">
                                <div class="row clearfix">
                                    <div class="col-sm-4">
                                        <div class="row clearfix">
            ...
            <div class="contentInner">
                <div class="col-lg-12 innerCards" id="content-area">
                    ...
                    <div class="header">
						...
						<a class="btn btn-default btn-common waves-effect pull-right" href="<?php echo e(url('/')); ?>/materialin/add">Add Record</a>
                    </div>
                    <div class="body">
                        <div class="table-responsive" id="invoiceListTableDiv">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $data['invoices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
												...
												<td>
                                                    <?php echo e(\Carbon\Carbon::parse($invoice['receive_date'])->format('d/m/Y')); ?>
                                                ...
                                                <td>
                                                    <div>
                                                        <a  href="<?php echo e(url('/')); ?>/materialin/view/<?php echo e($invoice['id']); ?>" style="cursor:pointer; text-decoration: none">
...
<?php /**PATH /home/j7lo9g5r3sz/public_html/portal.loiwalgroup.com/resources/views/invoice/invoice_list.blade.php ENDPATH**/ ?>