                    ...
                    <div class="card">
                         <div class="searchFormHeader">
                            <div id="demo" class="collapse">
                             <form id="searchuom" class="form-horizontal searchForm" autocomplete="off">
                                <div class="row clearfix">

                                    <div class="col-sm-4">
                                        <div class="row clearfix">
                                            <div class="col-lg-4 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                                <label for="uom_name_search">UOM</label>
                                            </div>
                                            <div class="col-lg-8 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" id="uom_name_search" name="uom_name_search" class="form-control" >
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-3">
                                        <a class="btn-reset waves-effect" onclick="resetUomSearch()">Reset</a>
            ...
            <div class="contentInner">
                <div class="col-lg-12 innerCards" id="content-area">
                    ...
                    <div class="header">
						...
						<a class="btn btn-default btn-common waves-effect pull-right slide-right">Add Unit of Measurement</a>
                    </div>
                    <div class="body">
                        <div class="table-responsive" id="uomListTableDiv">
                            <?php if(isset($data['uomall']) && !empty($data['uomall'])): ?>
                                <table id="uomListTable" class="table table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $data['uomall']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($uom['uom_name']); ?>

                                                  
                                                </td>
                                                <td>
                                                    <?php echo e($uom['uom_description']); ?>
                                                ...
                                                <td>
                                                    <div>
                                                        <a onclick="editUom(<?php echo e($uom['uom_id']); ?>)" style="cursor:pointer; text-decoration: none">
                                                            <img src="<?php echo e(url('/')); ?>/public/assets/images/edit.svg">
                                                        </a>
														<?php if($uom['product_count']<=0): ?>
                                                        <a onclick="deleteConfirm(<?php echo e($uom['uom_id']); ?>)" style="cursor:pointer; text-decoration: none">
                                                            <!--<i class="material-icons">delete</i>-->
                                                             <img src="<?php echo e(url('/')); ?>/public/assets/images/delete.svg">
                                                        </a>
														<?php endif; ?>
                                                    </div>
                                                    <div id="delconfirm_<?php echo e($uom['uom_id']); ?>" class="slidediv">
                                                        <div class="slidediv-inner">
                                                            <span class="label">
                                                                Would you like to delete?
                                                                <a href="javascript:;" onclick="delrecord(<?php echo e($uom['uom_id']); ?>, 'uom', 'uomListTableDiv', 'uomListTable')">Yes</a> | <a href="javascript:;" onclick="closedeldiv(<?php echo e($uom['uom_id']); ?>)">No</a>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </td>
                ...
                <div class="box col-lg-6 right-panel-big" style="width:100% !important;">
                    <div class="card innerCards">
                        <div id="addpanel">
                            ...
                            <div class="body">
                                <form id="addUom" class="form-horizontal" autocomplete="off">
                                    <div class="formwrap">
										<div class="row clearfix">
											<div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
												<label for="po">UOM<span class="col-pink">*</span></label>
											</div>
											<div class="col-lg-4 col-md-10 col-sm-8 col-xs-7">
												<div class="form-group">
													<div class="form-line">
														<input type="text" id="uom_name" name="uom_name" class="form-control" maxlength="50">
													</div>
												</div>
											</div>
											<div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
											...
											<div class="col-lg-4 col-md-10 col-sm-8 col-xs-7">
												<div class="form-group">
													<div class="form-line">
														<textarea id="uom_description" name="uom_description" class="form-control" maxlength="350"></textarea>
													</div>
												</div>
											</div>
                        ...
                        <div id="editpanel">
                            ...
                            <div class="body">
                                <form id="updateuom" class="form-horizontal" autocomplete="off">
									<div class="formwrap">
										<div class="row clearfix">
												<div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
													<label for="po">UOM<span class="col-pink">*</span></label>
												...
												<div class="col-lg-4 col-md-10 col-sm-8 col-xs-7">
													<div class="form-group">
														<div class="form-line">
															<input type="text" id="uom_name_edit" name="uom_name" class="form-control" maxlength="50">
														</div>
													</div>
												</div>
												<div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
												...
												<div class="col-lg-4 col-md-10 col-sm-8 col-xs-7">
													<div class="form-group">
														<div class="form-line">
															<textarea id="uom_description_edit" name="uom_description" class="form-control" maxlength="350"></textarea>
														</div>
													</div>
												</div>
...
<?php /**PATH /home/j7lo9g5r3sz/public_html/portal.loiwalgroup.com/resources/views/uom/uom_list.blade.php ENDPATH**/ ?>